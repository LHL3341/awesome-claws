...
For role-based agent operating systems, multi-agent workspaces, and persistent agent execution products.
...
- [**tencent-connect/openclaw-qq**](https://github.com/tencent-connect/openclaw-qq) ![GitHub stars](https://img.shields.io/github/stars/tencent-connect/openclaw-qq?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/tencent-connect/openclaw-qq?style=flat-square) — QQ Bot channel plugin covering private chat, groups, channels, DMs, and rich media.
