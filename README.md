...
- [**openclaw/openclaw**](https://github.com/openclaw/openclaw) ![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/openclaw/openclaw?style=flat-square) — 旗舰级个人 AI 助手。
...
- [**RightNow-AI/openfang**](https://github.com/RightNow-AI/openfang) ![GitHub stars](https://img.shields.io/github/stars/RightNow-AI/openfang?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/RightNow-AI/openfang?style=flat-square) — 面向长期运行、多角色协作和业务流程的 agent company 层。
...
- [**ValueCell-ai/ClawX**](https://github.com/ValueCell-ai/ClawX) ![GitHub stars](https://img.shields.io/github/stars/ValueCell-ai/ClawX?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/ValueCell-ai/ClawX?style=flat-square) — 面向 OpenClaw 的桌面 GUI 客户端，把命令行 AI 编排变成可视化桌面体验。
- [**gaoyangz77/easyclaw**](https://github.com/gaoyangz77/easyclaw) ![GitHub stars](https://img.shields.io/github/stars/gaoyangz77/easyclaw?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/gaoyangz77/easyclaw?style=flat-square) — 轻量级 OpenClaw 风格个人助手项目。
- [**RightNow-AI/openfang**](https://github.com/RightNow-AI/openfang) ![GitHub stars](https://img.shields.io/github/stars/RightNow-AI/openfang?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/RightNow-AI/openfang?style=flat-square) — OpenClaw 风格个人助手项目。
...
- [**openclaw/openclaw**](https://github.com/openclaw/openclaw) ![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/openclaw/openclaw?style=flat-square) — 跨消息渠道、浏览器自动化、设备、定时任务和工具的个人 AI 助手。
...
- [**moxxy-ai/moxxy**](https://github.com/moxxy-ai/moxxy) ![GitHub stars](https://img.shields.io/github/stars/moxxy-ai/moxxy?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/moxxy-ai/moxxy?style=flat-square) — 与 OpenClaw 相邻的助手项目。
- [**tinyfatco/troublemaker**](https://github.com/tinyfatco/troublemaker) ![GitHub stars](https://img.shields.io/github/stars/tinyfatco/troublemaker?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/tinyfatco/troublemaker?style=flat-square) — 与 OpenClaw 相邻的助手 / agent 项目。
- [**Kxrbx/Clawlet**](https://github.com/Kxrbx/Clawlet) ![GitHub stars](https://img.shields.io/github/stars/Kxrbx/Clawlet?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/Kxrbx/Clawlet?style=flat-square) — OpenClaw 生态中的轻量助手。
- [**vincenzodomina/supaclaw**](https://github.com/vincenzodomina/supaclaw) ![GitHub stars](https://img.shields.io/github/stars/vincenzodomina/supaclaw?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/vincenzodomina/supaclaw?style=flat-square) — OpenClaw 风格助手项目。
- [**yogesharc/babyclaw**](https://github.com/yogesharc/babyclaw) ![GitHub stars](https://img.shields.io/github/stars/yogesharc/babyclaw?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/yogesharc/babyclaw?style=flat-square) — 小型个人助手项目。
- [**Masmedeam/shrew**](https://github.com/Masmedeam/shrew) ![GitHub stars](https://img.shields.io/github/stars/Masmedeam/shrew?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/Masmedeam/shrew?style=flat-square) — 紧凑型自主助手运行时。
- [**czl9707/pickle-bot**](https://github.com/czl9707/pickle-bot) ![GitHub stars](https://img.shields.io/github/stars/czl9707/pickle-bot?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/czl9707/pickle-bot?style=flat-square) — 与 OpenClaw 相邻的机器人项目。
- [**Abdur-rahmaanJ/angel-claw**](https://github.com/Abdur-rahmaanJ/angel-claw) ![GitHub stars](https://img.shields.io/github/stars/Abdur-rahmaanJ/angel-claw?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/Abdur-rahmaanJ/angel-claw?style=flat-square) — OpenClaw 风格助手项目。
...
- [**Xiangyu-CAS/xiaohongshu-ops-skill**](https://github.com/Xiangyu-CAS/xiaohongshu-ops-skill) ![GitHub stars](https://img.shields.io/github/stars/Xiangyu-CAS/xiaohongshu-ops-skill?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/Xiangyu-CAS/xiaohongshu-ops-skill?style=flat-square) — 面向小红书运营的 OpenClaw skill / workflow 项目。
...
- [**Prismer-AI/Prismer**](https://github.com/Prismer-AI/Prismer) ![GitHub stars](https://img.shields.io/github/stars/Prismer-AI/Prismer?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/Prismer-AI/Prismer?style=flat-square) — 面向论文阅读、引文图谱、协作工作区和学术工作流的开源研究平台。
...
- [**shivamprasad1001/papermind-ai**](https://github.com/shivamprasad1001/papermind-ai) ![GitHub stars](https://img.shields.io/github/stars/shivamprasad1001/papermind-ai?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/shivamprasad1001/papermind-ai?style=flat-square) — 面向研究文档对话的 AI PDF 聊天应用。
...
- [**OpenHands/OpenHands**](https://github.com/OpenHands/OpenHands) ![GitHub stars](https://img.shields.io/github/stars/OpenHands/OpenHands?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/OpenHands/OpenHands?style=flat-square) — 开源 AI 驱动的软件开发平台与 software agent。
...
- [**microsoft/TaskWeaver**](https://github.com/microsoft/TaskWeaver) ![GitHub stars](https://img.shields.io/github/stars/microsoft/TaskWeaver?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/microsoft/TaskWeaver?style=flat-square) — 面向有状态数据分析与执行流程的 code-first agent 框架。
...
- [**VoltAgent/awesome-openclaw-skills**](https://github.com/VoltAgent/awesome-openclaw-skills) ![GitHub stars](https://img.shields.io/github/stars/VoltAgent/awesome-openclaw-skills?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/VoltAgent/awesome-openclaw-skills?style=flat-square) — 社区构建的 OpenClaw 技能精选目录。
...
- [**AIPMAndy/soskill**](https://github.com/AIPMAndy/soskill) ![GitHub stars](https://img.shields.io/github/stars/AIPMAndy/soskill?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/AIPMAndy/soskill?style=flat-square) — 开源的 Skill 搜索与聚合引擎，支持多源同步、风险审计和可复用索引输出。
- [**jasonzhangshuo/openclaw-community-skills**](https://github.com/jasonzhangshuo/openclaw-community-skills) ![GitHub stars](https://img.shields.io/github/stars/jasonzhangshuo/openclaw-community-skills?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/jasonzhangshuo/openclaw-community-skills?style=flat-square) — 社区共享 OpenClaw skills 仓库，包含 `openclaw-watchdog` 等条目。
...
- [**leohuang8688/clawmem**](https://github.com/leohuang8688/clawmem) ![GitHub stars](https://img.shields.io/github/stars/leohuang8688/clawmem?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/leohuang8688/clawmem?style=flat-square) — 轻量级 OpenClaw 记忆系统，提供三层检索、生命周期监听和基于 SQLite 的存储。
...
- [**SapienXai/AgentOS-MissionControl**](https://github.com/SapienXai/AgentOS-MissionControl) ![GitHub stars](https://img.shields.io/github/stars/SapienXai/AgentOS-MissionControl?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/SapienXai/AgentOS-MissionControl?style=flat-square) — 基于 OpenClaw 的人类控制层与 mission-control 工作台，用于统一协调 agents、项目与团队。
- [**xiaogong2000/catbus**](https://github.com/xiaogong2000/catbus) ![GitHub stars](https://img.shields.io/github/stars/xiaogong2000/catbus?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/xiaogong2000/catbus?style=flat-square) — 分布式 agent 通信系统，可让多台机器上的 OpenClaw 实例彼此发现、委派任务并协同执行。
...
- [**openclaw/openclaw**](https://github.com/openclaw/openclaw) ![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/openclaw/openclaw?style=flat-square) — 也可用于聊天原生自动化、定时任务和工具驱动助手。
...
- [**TriggerDotDev/trigger.dev**](https://github.com/triggerdotdev/trigger.dev) ![GitHub stars](https://img.shields.io/github/stars/triggerdotdev/trigger.dev?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/triggerdotdev/trigger.dev?style=flat-square) — 面向持久化 AI agents、后台任务、调度与长时自动化的托管工作流运行时。
## 商业与预测
...
- [**AIWerk/openclaw-mcp-bridge**](https://github.com/AIWerk/openclaw-mcp-bridge) ![GitHub stars](https://img.shields.io/github/stars/AIWerk/openclaw-mcp-bridge?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/AIWerk/openclaw-mcp-bridge?style=flat-square) — MCP 客户端插件，可把外部 MCP Server 通过 stdio、SSE、streamable HTTP 桥接成 OpenClaw 原生工具。
- [**hygao1024/astron-claw**](https://github.com/hygao1024/astron-claw) ![GitHub stars](https://img.shields.io/github/stars/hygao1024/astron-claw?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/hygao1024/astron-claw?style=flat-square) — 实时对话桥接服务，让 OpenClaw 通过 WebSocket、SSE 和 Token 配对机制获得 Web 聊天能力。
- [**bluenexus-ai/openclaw**](https://github.com/bluenexus-ai/openclaw) ![GitHub stars](https://img.shields.io/github/stars/bluenexus-ai/openclaw?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/bluenexus-ai/openclaw?style=flat-square) — 通用 MCP 插件，一层接入 GitHub、Notion、Slack、Google 等外部服务。
...
- [**DJTSmith18/openclaw-twilio**](https://github.com/DJTSmith18/openclaw-twilio) ![GitHub stars](https://img.shields.io/github/stars/DJTSmith18/openclaw-twilio?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/DJTSmith18/openclaw-twilio?style=flat-square) — 基于 Twilio 的 OpenClaw 电话 / 短信接入项目。
...
- [**ClawCall/clawcall**](https://github.com/ClawCall/clawcall) ![GitHub stars](https://img.shields.io/github/stars/ClawCall/clawcall?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/ClawCall/clawcall?style=flat-square) — 面向语音 / 通话场景的 OpenClaw 渠道接入项目。
- [**clawtell/channel**](https://github.com/clawtell/channel) ![GitHub stars](https://img.shields.io/github/stars/clawtell/channel?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/clawtell/channel?style=flat-square) — ClawTell 渠道插件，可把 agent-to-agent 消息路由进现有 OpenClaw 会话。
- [**clawparty-ai/openclaw-channel-plugin-ztm**](https://github.com/clawparty-ai/openclaw-channel-plugin-ztm) ![GitHub stars](https://img.shields.io/github/stars/clawparty-ai/openclaw-channel-plugin-ztm?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/clawparty-ai/openclaw-channel-plugin-ztm?style=flat-square) — ZeroTier / ZTM 相关的 OpenClaw 渠道插件。
- [**xigpz/openclaw-console**](https://github.com/xigpz/openclaw-console) ![GitHub stars](https://img.shields.io/github/stars/xigpz/openclaw-console?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/xigpz/openclaw-console?style=flat-square) — OpenClaw 可视化管理后台，覆盖配置、模型与 Skills 管理。
...
- [**FtlC-ian/openclaw-channel-zulip**](https://github.com/FtlC-ian/openclaw-channel-zulip) ![GitHub stars](https://img.shields.io/github/stars/FtlC-ian/openclaw-channel-zulip?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/FtlC-ian/openclaw-channel-zulip?style=flat-square) — Zulip 渠道插件，支持并发消息处理、反应指示器、文件上传和完整的 actions API。
- [**tloncorp/openclaw-tlon**](https://github.com/tloncorp/openclaw-tlon) ![GitHub stars](https://img.shields.io/github/stars/tloncorp/openclaw-tlon?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/tloncorp/openclaw-tlon?style=flat-square) — Tlon/Urbit 渠道插件，支持 DM、群组频道、线程回复和 ship 授权管理。
...
- [**njerschow/openclaw-sendblue**](https://github.com/njerschow/openclaw-sendblue) ![GitHub stars](https://img.shields.io/github/stars/njerschow/openclaw-sendblue?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/njerschow/openclaw-sendblue?style=flat-square) — 基于 Sendblue API 的 iMessage / SMS 渠道插件。
## 部署与运维
...
- [**OpenClawUP/local**](https://github.com/OpenClawUP/local) ![GitHub stars](https://img.shields.io/github/stars/OpenClawUP/local?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/OpenClawUP/local?style=flat-square) — 面向 macOS 的一键安装器和本地管理面板，可管理 OpenClaw 的渠道、模型与后台服务。
...
- [**BlockRunAI/awesome-OpenClaw-Money-Maker**](https://github.com/BlockRunAI/awesome-OpenClaw-Money-Maker) ![GitHub stars](https://img.shields.io/github/stars/BlockRunAI/awesome-OpenClaw-Money-Maker?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/BlockRunAI/awesome-OpenClaw-Money-Maker?style=flat-square) — 面向 OpenClaw 生态的变现主题精选列表。
- [**sameeerkashyap/awesome-claw**](https://github.com/sameeerkashyap/awesome-claw) ![GitHub stars](https://img.shields.io/github/stars/sameeerkashyap/awesome-claw?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/sameeerkashyap/awesome-claw?style=flat-square) — OpenClaw 风格开源 AI 助手目录。
- [**webvijayi/awesome-clawdbot-usecases**](https://github.com/webvijayi/awesome-clawdbot-usecases) ![GitHub stars](https://img.shields.io/github/stars/webvijayi/awesome-clawdbot-usecases?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/webvijayi/awesome-clawdbot-usecases?style=flat-square) — 聚焦实用业务和生产力场景的 OpenClaw 用例集合。
- [**jrleon30/awesome-openclaw-usecases-zh**](https://github.com/jrleon30/awesome-openclaw-usecases-zh) ![GitHub stars](https://img.shields.io/github/stars/jrleon30/awesome-openclaw-usecases-zh?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/jrleon30/awesome-openclaw-usecases-zh?style=flat-square) — 面向中文用户的已验证 OpenClaw 用例合集，适合本地化场景参考与新手入门。
