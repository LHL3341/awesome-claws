...
> 按使用场景整理的 OpenClaw 相关产品、技能、社区与生态资源清单。
...
- 想快速理解 OpenClaw 生态全貌的人
- 想找可直接使用项目、而不是只看底层框架的人
- 想做科研、自动化、coding agent、渠道接入或 skills 扩展的人
- 想持续跟踪 OpenClaw 周边新项目的人
...
- **精选**：快速建立整体印象
- **个人助手**：看 OpenClaw 风格产品主线
- **学术研究**：看科研工作流相关项目
- **编程开发**：看 coding / developer-facing agent 产品
- **自动化**：看工作流、工具编排与执行系统
- **技能与注册表**：看可复用 skills 与社区目录
- **部署与运维**：看一键安装、托管和控制面板
...
- [**HKUDS/nanobot**](https://github.com/HKUDS/nanobot) ![GitHub stars](https://img.shields.io/github/stars/HKUDS/nanobot?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/HKUDS/nanobot?style=flat-square) — 轻量级的 OpenClaw 风格助手。
- [**AstrBotDevs/AstrBot**](https://github.com/AstrBotDevs/AstrBot) ![GitHub stars](https://img.shields.io/github/stars/AstrBotDevs/AstrBot?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/AstrBotDevs/AstrBot?style=flat-square) — 支持多平台的 agent 化 IM 聊天机器人基础设施。
...
- [**langgenius/dify**](https://github.com/langgenius/dify) ![GitHub stars](https://img.shields.io/github/stars/langgenius/dify?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/langgenius/dify?style=flat-square) — 面向 agent 工作流的生产级平台。
- [**n8n-io/n8n**](https://github.com/n8n-io/n8n) ![GitHub stars](https://img.shields.io/github/stars/n8n-io/n8n?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/n8n-io/n8n?style=flat-square) — 拥有强大 AI 与集成能力的自动化平台。
...
适用于基于角色的 agent 操作系统、多 agent 工作区和持久化 agent 运行产品。
