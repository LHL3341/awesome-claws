...
- [**tencent-connect/openclaw-qq**](https://github.com/tencent-connect/openclaw-qq) ![GitHub stars](https://img.shields.io/github/stars/tencent-connect/openclaw-qq?style=flat-square) ![Last commit](https://img.shields.io/github/last-commit/tencent-connect/openclaw-qq?style=flat-square) — QQ Bot 渠道插件，覆盖私聊、群聊、频道、私信与富媒体消息。
